...
3. 回到 Media Types 页面，可以看到已经导入的 media type。点击名称，进入编辑页面，补全 URL、zabbix_url 以及 HTTPProxy 等内容：
   ...
   <img alt="drawing" width="600" src="https://img.github.io/Wa1lJ6E3soYLZa2u6CJUpyAbJsVvqjqDuTl2m5pyK-g.avif" />
...
- 其他配置使用默认配置，保持不变
   ...
   <img alt="drawing" width="600" src="https://img.github.io/NQZGtjnDMgN5oBrDr-I7TfOtAVCihNKlxVsahULxRMg.avif" />
...
- 重复以上步骤，完成对 `Recovery operations` 和 `Update operations` 的配置
   ...
   <img alt="drawing" width="600" src="https://img.github.io/eBJqunprfGJYQKJ843YcyuGkeEtykZmW2n9Wme-xqTc.avif" />
   <img alt="drawing" width="600" src="https://img.github.io/EPSOBfH6Q2QrVkBSqKBj5rEJxsrnm7VD2gaoczsAl00.avif" />
...
<img alt="drawing" width="600" src="https://img.github.io/OXyBJbDkZ1sj4otE-Is2dYelUR6ggs6rHPr-VtC3JGk.avif" />
...
- `{ALERT.MESSAGE}`：告警信息，保持在第二个参数
  ...
  - `HTTPProxy`：如果您的 Zabbix Server 不能直接访问 Flashduty 服务，可以将该参数设置为一个代理地址。如果没有空着即可，保持在第五个参数
   ...
   <img alt="drawing" width="600" src="https://img.github.io/Pv1jMnTxVQTysLQ8P6aBOVM8MChQKRarA8SW01QX-1c.avif"/>
...
1. 登录 Zabbix 控制台，选择 `Administration > Users`，选择 Admin 用户，选择 media，选择 Add，进入编辑窗口：
   ...
   - 其他配置使用默认配置，保持不变
      ...
      <img alt="drawing" width="600" src="https://img.github.io/GWCfInrRqnlRwvapcrtU-olJfugWnKPWNB6ZZ7BLpsY.avif" />
...
2. 选择 `Operations`，分别更新三种场景的通知用户配置：
   ...
   - 重复以上步骤，完成对 `Recovery operations` 和 `Update operations` 的配置
      ...
      <img alt="drawing" width="600" src="https://img.github.io/HlbY6VbtYAM28b-HLPawASZgS_QHOMmhsx0V2X9QabQ.avif" />
...
- 重复以上步骤，完成对 `Recovery operations` 和 `Update operations` 的配置
   ...
   <img alt="drawing" width="600" src="https://img.github.io/uLSWCypOMpiVbmkFV38ApSvAF3wiRw6ci5Gu1d_SbWk.avif" />
...
2. 找到 Flashduty 对应日志，如果 Status 为 Sent，代表通知成功。否则根据提示排查原因
   ...
   <img alt="drawing" width="600" src="https://img.github.io/ZWiq1b69iYwn2zoaaTSqjHCvFiIkRe68itpXEnQes1A.avif" />
